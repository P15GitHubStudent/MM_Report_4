...
##  Σύνοψη
Υλοποίησα όλα τα ζητούμενα και των τεσσάρων παραδοτέων. Επίσης έδωσα  την δυνατότητα στον παίκτη να μπορεί να ρίχνει φωτιές από τα χέρια του για  ένα  περιορισμένο χρονικό διάστημα όταν πάρει ένα sprite φωτιάς το οποίο περιστρέφεται στην πίστα. Επίσης έγινε προσθήκη βοηθητικών πινακίδων(αναλύονται στην συνέχεια).Ακόμα έγινε προσθήκη Game Over Menu καθώς και wonGame Menu.Τέλος Αλλαξά την μουσικής της πίσταςΠροσθεσα  ηχο οταν ο παίκτης παίρνει μανιτάρι και οταν η πριγκίπισσα φιλάει τον παίκτη.
...
![playerlostheart](https://user-images.githubusercontent.com/22703561/35153200-27a4b7d0-fd2e-11e7-8473-aa30627cb7b7.gif)

![gameoverstate](https://user-images.githubusercontent.com/22703561/35153195-26edf126-fd2e-11e7-9e5c-e3c4c0668c0f.gif)

Ο πάικτης ξεκινάει με πέντε καρδίες,δεν μπορεί να ξεπεράσει τις εφτά κάθε φορά που χάνει μια ζωή γίνεται επανακκίνηση τις πίστας μας(κινούμενη εικόνα 1)
εκτός και αν χάσει όλες του τις ζωές τότε θα μεταβεί στο GameOver State((κινούμενη εικόνα 2).
...
τότε τον ακολουθεί.Σε αντίθεση με τους άλλους εχθρούς το φάντασμα σκοτώνεται μόνο οταν συγκουστεί με τον παίκτη μας η απο φωτία το οποίο θα οδηγήσει επίσης τον παίκτη να χάσει μια ζωή για να αντιμετωπίσεις το φάντασμα πρέπει να αποφύγης να πας πολύ κοντά του η αμα πας αρκετά κοντά πρέπει να τρέξεις για να μην συγκρουστής μεταξύ του. 
...
### Bonus-αντικείμενα
![bonus](https://user-images.githubusercontent.com/22703561/35153960-1e863400-fd31-11e7-8ef4-3afc82adde9c.gif)
...
### endofLevelAnimation
 ![nextmap](https://user-images.githubusercontent.com/22703561/35152642-deb1a710-fd2b-11e7-8274-bd24b18ccc70.gif)
 ...
 Στην πρώτη εικόνα το NextLevelState θα φωρτόσει την επόμενη πίστα,ενώ στην δεύτερη εικόνα θα φωρτόσει το WonGame state
...
![screenshot_1](https://user-images.githubusercontent.com/22703561/34299643-bc046b0e-e72c-11e7-8523-57882618a597.png)
 ...
 Οθόνη όταν ο παίκτης έχασε όλες τις ζωές του ολοκλήρωση τις πίστας δείχνει το score που κατάφερε, επίσης δίνει την δυνατότητα στο      άτομο αυτό να διαλέξει άμα θα ήθελε να μεταβεί στο κύριο μενού η να κάνει επανεκκίνηση την τρέχουσα πίστα που δεν κατάφερε να ολοκληρώσει.

## Menu
![menu](https://user-images.githubusercontent.com/22703561/35153468-5049fbcc-fd2f-11e7-86b3-c653bdd53014.gif)

 Μενού έχει διαθέσιμα δυο κουμπιά το πρώτο ξεκινάει την πρώτη πίστα ενώ το δεύτερο ξεκινάει το LevelSelectState. 

## LevelSelect

![levelselection](https://user-images.githubusercontent.com/22703561/35153739-72e8be6a-fd30-11e7-9fb2-26217363a372.gif)

 * Μενού επιλογής πίστας, τα αστεράκια υποδηλώνουν την δυσκολία τις πίστας μας ,το λουκέτο δείχνει ότι είναι κλειδωμένη
