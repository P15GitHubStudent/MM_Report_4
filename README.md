...
## LoadNextLevelState
Με το πέρας μια πίστας αναλαμβάνει να φορτώσει την επόμενη πίστα, οταν δεν θα υπάρξει επόμενη πίστα να φορτώσει τότε θα μεταβεί στην WonGame State.


## Menu
![menu1](https://user-images.githubusercontent.com/22703561/33543806-158f0d50-d8e1-11e7-95f7-c81dfc3aebf2.png)
  * 1) Μενού εχει διαθέσιμα δυο κουμπία το ενα είναι το mapstart το οποίο δυνδεεται με την φόρτωση μιας τυχαίας πίστας απο τις διαθέσιμες, δεύτερη επιλογή είναι το levelSelect το οποίο ξεκινάει το LevelSelectState. 
