...
τον προγραμματιστή να μην χάνει ζωές.Τέλος  κάθε φορά που ήμουν σίγουρος οτι ολα δουλεύουν οπως πρέπει τα ανέβαζα στο github επίσης μου αυτό μου έδωσε την δυνατότητα να επιστρέψω σε προηγούμενες εκδόσεις που δουλεύουν αμα έκανα κάποιο λάθος.
